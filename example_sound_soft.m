...
%
%   example_sound_soft computes the far field ff for the point-source
...
%
%   Changing 'POINTSOURCE' to 'PLANEWAVE' in Line 35 computes the far field
...
%
% See also: check_sound_soft, example_transmission, plane_wave.
%
% References:
%
...
ff = fast_multiple_scattering_soft(tp,'POINTSOURCE');
